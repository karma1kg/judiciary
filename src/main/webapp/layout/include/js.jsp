...
<script type="text/javascript" src="<c:url value='/resources/js/vendors/bootstrap-multiselect.js'/>"></script>
<script type="text/javascript" src="<c:url value='/resources/js/vendors/bootstrap-multiselect.min.js'/>"></script>
...
<%--<script type="text/javascript" src="<c:url value='/resources/js/vendors/jquery.multiselect.js'/>"></script>--%>
