...
<html>
<head>
    <title>Application for Translation of Marriage Certificate Registration Form</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Translation of Marriage Certificate Registration Form </span>

    <div class="col-12">
        <form class="card form-horizontal" id="affirmationMarriageCertificateFormId"
              action="<c:url value='/affirmationMarriageCertificate'/>" method="post" enctype="multipart/form-data">
            <div class="card-body">
