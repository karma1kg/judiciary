...
<html>
<head>
    <title>Application for Marriage Certificate Registration Form</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Marriage Certificate Registration Form </span>

    <div class="col-12">
        <form class="card form-horizontal" id="marriageCertificateFormId"
              action="<c:url value="/marriageCertificate"/>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                <span class="text-danger">
              &nbsp;&nbsp;&nbsp;&nbsp;NOTE:  Label markED with * are mandatory fields, you cannot proceed further without those fields.
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="personalDetailTab">
                                        ...
                                        <input type="hidden" readonly="true" class="form-control field" name="householdNo" id="householdNo">
                                        <input type="hidden" readonly="true" class="form-control field" name="dzongkhagName" id="dzongkhagName">
                                        <input type="hidden" readonly="true" class="form-control field" name="gewogName" id="gewogName">
                                        <input type="hidden" readonly="true" class="form-control field" name="villageName" id="villageName">
                                        <input type="hidden" readonly="true" class="form-control field" name="gender" id="applicantGender">
                                        <input type="hidden" readonly="true" class="form-control field" name="relationToHOH" id="relationToHOH">
                                        <input type="hidden" readonly="true" class="form-control field" name="marital_Status" id="marital_Status">
                                        <input type="hidden" readonly="true" class="form-control field" name="dob" id="dob">
                                        <input type="hidden" readonly="true" class="form-control field" name="nationality" id="nationality">
                                        <input type="hidden" readonly="true" class="form-control field" name="fatherCid" id="fatherCid">
                                        <input type="hidden" readonly="true" class="form-control field" name="fatherNationality" id="fatherNationality">
                                        <input type="hidden" readonly="true" class="form-control field" name="motherCid" id="motherCid">
                                        <input type="hidden" readonly="true" class="form-control field" name="motherNationality" id="motherNationality">

                                            <div class="card"  id="housholdApplicantDetailsID" <%--style="display: none"--%>>
                                                    ...
                                                    <div class="col-lg-12">
                                                        <table>
                                                            ...
                                                            <tr>
                                                                <th> &nbsp; &nbsp; &nbsp;&nbsp;Houshold No. :
                                                                <td>23456&nbsp; &nbsp; &nbsp;&nbsp;</td></th>
                                                                <th>Dzongkhag : <td>23456&nbsp; &nbsp; &nbsp;&nbsp;</td></th>
                                                                <th>Gewog : <td>23456&nbsp; &nbsp; &nbsp;&nbsp;</td></th>
                                                                <th>Village : <td>23456 &nbsp; &nbsp; &nbsp;&nbsp;</td></th>
                                                                <th>House No. : <td>23456&nbsp; &nbsp; &nbsp;&nbsp;</td></th>
                                                                <th>Thram No. : <td>23456</td></th>
                                                            </tr>
                                                            </thead>
                                                        <tbody>
                                                        ...
                                                        <table class="table table-bordered table-center table-responsive-lg auto-index" id="housholdApplicantDetailsThID">
                                                            <thead>
                                                            <tr>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Sl No.</label></b></th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Name</label></b></th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Cid</label></b></th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Sex</label></b></th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Relation to HOH</label></b></th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Marital Status</label></b></th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>DOB</label></b></th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Nationality</label></b></th>
                                                                <th> <table>
                                                                <tr><th style="color: rgba(0, 0, 0, 0.69)"><b><label>Father CID</label></b></th></tr>
                                                               <tr> <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Father Name</label></b></th></tr></table> </th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Father's Natinality</label></b></th>
                                                                <th> <table>
                                                                    <tr><th style="color: rgba(0, 0, 0, 0.69)"><b><label>Mother's CID</label> </b></th></tr>
                                                                    <tr> <th style="color: rgba(0, 0, 0, 0.69)"><b><label>Mother Name</label></b></th></tr></table> </th>
                                                                <th style="color: rgba(0, 0, 0, 0.69)"> <b><label>Mother's Nationality</label></b></th>
                                                            </tr>
                                                            </thead>
                                                            <tbody>
                                       ...
                                       <%-- <input type="hidden" readonly="true" class="form-control field" name="applicantDobBh" id="applicantDobBh">--%>
                                        ...
                                        <div class="card"  id="spouseHousholdDetailTableId" style="display: none">
                                            <div class="bg-blue card-status card-status-left"></div>
                                            <div class="card-body">
                                                <div class="col-lg-12">
                                                    <table>
                                                    ...
                                                    <tr style='border-top: hidden'>
                                                        <td>
                                                            <input type="file" class="alert badge-danger attachedFile" id="attachedFile"
                                                                   ...
                                                                   accept="image/jpeg,image/png,.doc,.docx,.pdf,.xlsx,.xls" required>
                                                        </td>
                                                        <td>
                                                            <button class='btn btn-sm btn-danger hidden' type='button'
