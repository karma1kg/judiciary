...
<html>
<head>
    <title>Application for Attestation of Documents Registration Form</title>
</head>
...
<div class="my-3 my-md-5" id="registration">
    <div class="container">
        <div class="row">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Attestation of Documents Registration Form </span>

            <div class="col-12">
                <form class="card form-horizontal" id="attestationDocumentFormId"
                      action="<c:url value='/attestationDocument'/>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="documentSelectionTab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control field" name="reason" id="reason"
                                                              placeholder="Reason for Attestation of Documents"
                                                              maxlength="250"></textarea>
                                            ...
                                            <div class="tab-pane" id="otherInformationTab">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                                                    <label><b> Please note that all the below given list of documents must be brought along with you during the date of appointment. Each person applying for the service must produce the following documents:<span class="text-danger">*</span></b></label>
                                                    <br />
                                                    <ol>
