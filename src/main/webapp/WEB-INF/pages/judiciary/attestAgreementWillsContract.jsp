...
<html>
<head>
    <title>Application for Attest Wills,Contracts,Agreements and Testaments Registration Form</title>
</head>
...
<div class="my-3 my-md-5" id="registration">
    <div class="container">
        <div class="row">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Attest Wills,Contracts,Agreements and Testaments Registration Form </span>

            <div class="col-12">
                <form class="card form-horizontal" id="attestAgreementWillsContractFormId"
                      action="<c:url value='/attestAgreementWillsContract'/>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                                            ...
                                            <div class="tab-pane" id="documentSelectionTab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control field" name="reason" id="reason"
                                                              placeholder="Reason for Attesting Agreement, Wills, Contracts and Testaments"
                                                              maxlength="250"></textarea>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table card-table table-vcenter text-nowrap"
                                                            ...
                                                            <tr style='border-top: hidden'>
                                                                <td>
                                                                    <input type="file" class="alert badge-info attachedFile" id="attachedFile"
