...
<html>
<head>
    <title>Application for Authentication of Personal Details Registration Form</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Authentication of Personal Details Registration Form </span>

    <div class="col-12">
        <form class="card form-horizontal" id="authenticationPersonalDetailsFormId"
              action="<c:url value='/authenticationPersonalDetails'/>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="personalDetailTab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <span id="lostDocTypeErrorMsg" class="text-danger"></span>
                                            </div>
                                            </div>
                                            <div class="form-group" id="incorrectNameDiv" style="display: none">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control" name="incorrectName" id="incorrectName">
                                                </div>
                                            </div>
                                            <div class="form-group" id="incorrectDobDiv" style="display: none">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control datepicker"
                                                           name="incorrectDate" id="incorrectDate" placeholder="12-Feb-2021 format" value="01-Jan-2021">
                                                </div>
                                            </div>
                                            <div class="form-group" id="incorrectCidNoDiv" style="display: none">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" class="form-control"
                                                           name="incorrectCidNo" id="incorrectCidNo" maxlength="11" placeholder="Incorrect CID number">
                                                </div>
                                            </div>
                                        <div id="incorrectGewogNameDiv" style="display: none">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <select id="incorrectGewogName" name="incorrectGewogName"
                                                                 class="form-control">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <select id="incorrectVillageName" name="incorrectVillageName"
                                                                 class="form-control">
                                                        <option value="0" label="--SELECT--"></option>
                                                    </select>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <textarea class="form-control field" name="reason" id="reason"
                                                              placeholder="Reason for Authentication of personal details"
                                                              maxlength="250"></textarea>
                                    ...
                                    <div class="tab-pane" id="otherInformationTab">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-lg-12 col-xs-12 form-group">
                                            <label><b> Please note that all the below given list of documents must be attached and brought along with you during the date of appointment. Each person applying for the this services must produce the following documents:<span class="text-danger">*</span></b></label>
                                            <ol>
                                        ...
                                        <div id="fileAttachmentDiv">
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-6">
                                                    Please attach the above required files :
                                                </label>
                                            </div>
                                                    ...
                                                    <tr style='border-top: hidden'>
                                                        <td>
                                                            <input type="file" class="alert badge-danger attachedFile" id="attachedFile"
                                                                   ...
                                                                   required>
                                                            <span class="text-danger" id="attachedFileErrorMsg"></span>
                                                        </td>
                                                        <td>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-3 pull-right">
                                                ...
                                                <button type="submit" id="btnSubmitAD" class="btn btn-primary">
