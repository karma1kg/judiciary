...
<html>
<head>
    <title>Application for Lost Document Registration Form</title>
</head>
...
<div class="my-3 my-md-5" id="registration">
    <div class="container">
        <div class="row">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Lost Document Registration Form </span>

            <div class="col-12">
                <form class="card form-horizontal" id="lostDocumentFormId"
                      action="<c:url value='/lostDocument'/>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
              ...
              Please follow the instruction in &nbsp;&nbsp;<img src="<c:url value="/resources/images/questionMark.jpg"/>"
                                                                class="user-image" width="20px">  </span>
                                                ...
                                                <li id="otherInformation">
                                                    <a href="#otherInformationTab" id="otherInformationTabId"
                                                       ...
                                                       title='Please use buttons to change tabs.'><i
                                                            class="fe fe-paperclip"></i>&nbsp;Attachment
                                                        <span class="text-info"  id="otherInformationCheck"></span> </a>
                                                </li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="tab-pane" id="personalDetailTab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-2 required">
                                                        Document Lost:
                                                        <a data-toggle="tooltip" data-placement="top"
                                                           title='Select your lost document type from given below list'
                                                           class="tooltipCSSSelector">
                                                            <img src="<c:url value="/resources/images/questionMark.jpg"/>" class="user-image"
                                                                 width="20px">
                                                        </a>
                                                    ...
                                                    <div class="col-sm-4">
                                                                <form:select id="lostDocType" name="lostDocType" path="documentList" required="required" class="form-control field">
                                            ...
                                            <div class="tab-pane" id="documentSelectionTab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control field" name="reason" id="reason"
                                                              placeholder="Reason for Lost Documents"
                                                              maxlength="250"></textarea>
