...
<html>
<head>
    <title>Application for Single/Marital Status Registration Form</title>
</head>
<body class="">
<div class="my-3 my-md-5">
    <div class="container">
        <div class="row">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Single/Marital Status Registration Form </span>
            <div class="col-12">
                <form class="card form-horizontal" id="singleMaritalStatusFormId"
                      action="<c:url value='/singleMaritalStatus'/>" method="post" enctype="multipart/form-data">
                    <div class="card-body">
                                            ...
                                            <div class="tab-pane" id="documentSelectionTab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control field" name="reason" id="reason"
                                                              placeholder="Reason for Single/Marital status"
                                                              maxlength="250"></textarea>
