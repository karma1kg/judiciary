...
<html>
<head>
    <title>Verification for Child Adoption</title>
</head>

<body>
<div class="row" id="registration">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Child Adoption</span>
            <div class="col-12">
                <form class="card form-horizontal" id="approveChildAdoptionFormId"
                      action="<c:url value='/approveChildAdoption'/>" method="post">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="personalDetailTab">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Spouse Cid No:</label>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Child Gender:</label>
                                                    <div class="col-sm-4">
