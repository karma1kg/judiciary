...
<html>
<head>
    <title>Verification for Lost Documents</title>
</head>

<body>
<div class="row" id="registration">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Lost Documents</span>

            <div class="col-12">
                <form class="card form-horizontal" id="approveLostDocumentFormId" action="<c:url value='/approveLostDocument'/>" method="post">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="personalDetailTab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label class="col-sm-2">Document Lost:</label>
                                                    <div class="col-sm-4">
                                                        <form:select id="lostDocType" name="lostDocType" path="documentTypeList"
                                                                     class="form-control readonly-field">
                                                            <form:options items="${documentTypeList}" itemValue="valueInteger"
