...
<html>
<head>
    <title>Verification for Attestation of Documents</title>
</head>

<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Attestation of Documents</span>
    <div class="col-12">
        <form class="card form-horizontal" id="approveAttestationDocumentFormId"
              action="<c:url value='/approveAttestationDocument'/>" method="post">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="documentSelectionTab">
                                        <br/>
                                        <div class="form-group">
                                            <label class="col-sm-2 required">Mobile Number:</label>
                                            <div class="col-sm-4">
                                    ...
                                    <div class="tab-pane" id="otherInformationTab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="time" class="form-control" id="appoinmentTime" name="appoinmentTime" min="09:00" max="15:30" hours_limit = "12" pattern="^\d{1,2}([:.]?\d{1,2})?([ ]?[a|p]m)?$">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                    <textarea class="form-control field" name="remarks"
                                                              id="remarks" value="Approved"></textarea>
                                            ...
                                            <div class="col-sm-4" id="aaa">
                                                <form:select id="rejectReasons" name="rejectReason"
                                                             path="reject_attest" class="form-control field">
                                                    <form:option value="0" label="--SELECT--"></form:option>
                                                    <form:options items="${reject_attest}" itemValue="valueInteger"
