...
<html>
<head>
    <title>Verification for Attest Wills,Contracts,Agreements and Testaments</title>
</head>

<body>
<div class="row" id="registration">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Attest Wills,Contracts,Agreements and Testaments</span>
            <div class="col-12">
                <form class="card form-horizontal" id="approveAttestAgreementWillsContractFormId"
                      action="<c:url value='/approveAttestAgreementWillsContract'/>" method="post">
                    <input type="hidden" class="form-control field" name="applicationNo" id="applicationNo"
                           value="${applicationNo}">
                    <input type="hidden" class="form-control field" name="applicationYear" id="applicationYear"
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="otherInformationTab">
                                               ...
                                               <%-- <div class="form-group rejectRemarksDiv" style="display: none;">
                                                    ...
                                                    <label class="col-sm-2"> Reject Remarks:</label>
                                                    <div class="col-sm-4">
                                                  <textarea class="form-control field" name="rejectRemarks"
                                                            id="rejectRemarks"  placeholder="Type brief reject remarks"></textarea>
                                                        <span id="rejectRemarksErrorMsg" class="text-danger"></span>
                                                    </div>
                                                </div>--%>
                                                <hr/>
                                                <div class="form-group">
