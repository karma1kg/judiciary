...
<html>
<head>
    <title>Verification for Single/Marital Status</title>
</head>
<body>
<div class="row" id="registration">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Single/Marital Status</span>
            <div class="col-12">
                <form class="card form-horizontal" id="approveSingleMaritalStatusFormId"
                      action="<c:url value='/approveSingleMaritalStatus'/>" method="post">
                    <div class="card-body">
