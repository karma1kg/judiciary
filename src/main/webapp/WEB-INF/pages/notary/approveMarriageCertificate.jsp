...
<html>
<head>
    <title>Verification for Marriage Certificate</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Marriage Certificate</span>

    <div class="col-12">
        <form class="card form-horizontal" id="approveMarriageCertificateFormId"
              action="<c:url value="/approveMarriageCertificate"/>" method="post">
            <div class="card-body">
