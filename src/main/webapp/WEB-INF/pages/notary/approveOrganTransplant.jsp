...
<html>
<head>
    <title>Verification for Organ Transplant</title>
</head>

<body>
<div class="row" id="registration">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Organ Transplant</span>
            <div class="col-12">
                <form class="card form-horizontal" id="approveOrganTransplantFormId"
                      action="<c:url value='/approveOrganTransplant'/>" method="post">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="personalDetailTab">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Applicant Cid No: </label>
                                                    <div class="col-sm-4">
                                                ...
                                                <hr/>
                                                <div class="form-group">
                                                    <label class="col-sm-2">Patient Cid No:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="patientCid" name="patientCid"/>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Patient Gender:</label>
                                                    <div class="col-sm-4">
                                                        <select id="patientGender" name="patientGender" class="form-control readonly-field">
                                                            <option value="M">Male</option>
                                                            <option value="F">Female</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <hr/>
                                                <div class="form-group">
                                                    <label class="col-sm-2"> Donor Cid No:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="donorCid"
                                                               name="donorCid"/>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Donor Gender</label>
                                                    <div class="col-sm-4">
                                                        <select id="donorGender" name="donorGender"  class="form-control readonly-field">
                                                ...
                                                <hr/>
                                                <div class="form-group">
                                                    <label class="col-sm-2">Donor Dep. Cid No: </label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="donorDepCid"
                                                               name="donorDepCid" />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Dependent Gender:</label>
                                                    <div class="col-sm-4">
                                                        <select id="donorDepGender" name="donorDepGender"  class="form-control readonly-field">
                                                            <option value="M">Male</option>
                                                            <option value="F">Female</option>
                                                        </select>
                                                    </div>
                                                ...
                                                <hr/>
                                                <div class="form-group">
                                                    <label class="col-sm-2">Witness1 Cid No:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="witness1CidNo"
                                                               name="witness1CidNo"/>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Witness2 Cid No:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="witness2CidNo"
                                                               name="witness2CidNo"/>
                                                    </div>
                                            ...
                                            <div class="tab-pane" id="documentSelectionTab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <form:select id="courtId" name="courtId" path="court_list" class="form-control readonly-field">
                                                            <%
