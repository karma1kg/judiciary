...
<html>
<head>
    <title>Verification for Child Travel Document</title>
</head>

<body>
<div class="row" id="registration">
            <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Child Travel Document</span>
            <div class="col-12">
                <form class="card form-horizontal" id="approveChildTravelDocumentFormId"
                      action="<c:url value='/approveChildTravelDocument'/>" method="post">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane" id="personalDetailTab">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2"> Child Name:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="childName" name='childName'>
                                                    </div>
                                                    <label class="col-sm-2">Child DoB:</label>

                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" name="childDob" id="childDob">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2">Gender:</label>
                                                    ...
                                                    <label class="col-sm-2">Relationship to the Child: </label>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-2">Place of Travel:</label>

                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" name="travelPlace" id="travelPlace">
                                                    </div>
                                                </div>
                                                <label><i class="fa fa-male"></i>&nbsp;<u>Biological Parent's Details</u></label></br></br>
                                                <div class="form-group">
                                                    <label class="col-sm-2"> Father Cid No:</label>

                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="orgFatherCid" name="orgFatherCid" />
                                                    </div>
                                                    <label class="col-sm-2">Father Name:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" name="orgFatherName" id="orgFatherName">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2">Mother Cid No: </label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" id="orgMotherCid" name="orgMotherCid"/>
                                                    </div>
                                                    <label class="col-sm-2">Mother Name:</label>
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control readonly-field" name="orgMotherName" id="orgMotherName">
                                                    </div>
                                                </div>
                                                <hr/>
