...
<html>
<head>
    <title>Update for New Marriage Certificate</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for New Marriage Certificate in Dzongkha</span>
    <div class="col-12">
        <form class="card form-horizontal" id="updateNewMarriageCertificateFormId" action="<c:url value="/updateNewMarriageCertificate"/>" method="post">
            <div class="card-body">
