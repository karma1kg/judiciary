...
<html>
<head>
    <title>Application for Divorce Marriage Certificate Registration Form</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Divorce Marriage Certificate Registration Form </span>

    <div class="col-12">
        <form class="card form-horizontal" id="divorceApplicationFormId"
              action="<c:url value='/divorceApplication'/>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="personalDetailTab">
                                        ...
                                        <%--<input type="hidden" readonly="true" class="form-control field" name="judgementNo" id="judgementNos">--%>
                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    <label class="col-sm-12">
                                        ...
                                        <span id="courtName"></span> court for verification and approval. You may track your application status
