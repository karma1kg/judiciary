...
<html>
<head>
    <title>Update for Authentication of Personal Details</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Authentication of Personal Details</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateAuthenticationPersonalDetailsFormId" action="<c:url value='/updateAuthenticationPersonalDetails'/>" method="post">
            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="personalDetailTab">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2">CIC No. </label>
                                            <div class="col-sm-4">
