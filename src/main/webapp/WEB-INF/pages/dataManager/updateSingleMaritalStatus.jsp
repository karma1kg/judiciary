...
<html>
<head>
    <title>Update for Single/Marital Status</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Single/Marital Status</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateSingleMaritalStatusFormId"
              action="<c:url value='/updateSingleMaritalStatus'/>" method="post">
            <div class="card-body">
