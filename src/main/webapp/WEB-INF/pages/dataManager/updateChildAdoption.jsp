...
<html>
<head>
    <title>Update for Child Adoption</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Child Adoption</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateChildAdoptionFormId"
              action="<c:url value='/updateChildAdoption'/>" method="post">
            <div class="card-body">
                                        ...
                                        <li id="personalDetails">
                                            <a href="#personalDetailTab" id="personalDetailTabId" data-toggle="tab"
                                               data-placement="top" title='Please use buttons to change tabs.'><i
                                                    class="fa fa-user"></i>&nbsp;Child Adoption Details<span
