...
<html>
<head>
    <title>Update for Child Travel Details</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Child Travel Details</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateChildTravelDocumentFormId"
              action="<c:url value='/updateChildTravelDocument'/>" method="post">
            <div class="card-body">
