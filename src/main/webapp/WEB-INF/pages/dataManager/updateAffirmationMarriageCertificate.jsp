...
<html>
<head>
    <title>Update for Affirmation of Marriage Certificate</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Affirmation of Marriage Certificate</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateAffirmationMarriageCertificateFormId"
              action="<c:url value='/updateAffirmationMarriageCertificate'/>" method="post">
            <div class="card-body">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li id="documentSelection">
                                            <a href="#documentSelectionTab" id="documentSelectionTabId"
                                               data-toggle="tab"
                                               data-placement="top" title='Please use buttons to change tabs.'><i
                                                    class="fa fa-book"></i>&nbsp;Spouse Details<span class="text-info" style="font-size: 20px"
                                        ...
                                        <li id="otherInformation">
                                            <a href="#otherInformationTab" id="otherInformationTabId"
                                               ...
                                               title='Please use buttons to change tabs.'><i
                                                    class="fe fe-paperclip"></i>&nbsp;Judgment Details<span
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane" id="documentSelectionTab">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control readonly-field" id="spouseCidNo"
                                                       name="spouseCidNo"/>
                                            </div>
                                            <label class="col-sm-2">Full Name</label>
                                    ...
                                    <div class="tab-pane" id="otherInformationTab">
                                        <br/>
                                        <div class="form-group">
                                            <label class="col-sm-2 required">Case No.</label>
                                            <div class="col-sm-4">
                                               ...
                                               <%-- <input type="text" class="form-control" name="applicationYear" value="${applicationYear}">--%>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2 required">Registration No.</label>
                                            <div class="col-sm-3">
                                                <input type="text" class="form-control field" name="regNo" id="regNo">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 required">Judgement No.
                                               <%-- <% String username = (String) request.getAttribute("ApplicationYear"); %>
                                                <%= username %>--%> </label>
                                            <div class="col-sm-3">
