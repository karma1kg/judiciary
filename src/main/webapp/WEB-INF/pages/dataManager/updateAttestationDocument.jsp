...
<html>
<head>
    <title>Update for Attestation of Documents</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Attestation of Documents</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateAttestationDocumentFormId"
              action="<c:url value='/updateAttestationDocument'/>" method="post">
            <div class="card-body">
