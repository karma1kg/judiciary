...
<html>
<head>
    <title>Update for Lost Document</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Lost Document</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateLostDocumentFormId"
              action="<c:url value='/updateLostDocument'/>" method="post">
            <div class="card-body">
