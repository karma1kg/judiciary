...
<html>
<head>
    <title>Update for Attest Agreements,Wills, contracts and Testaments</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Attest Agreements,Wills, contracts and Testaments</span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateAttestAgreementWillsContractFormId"
              action="<c:url value='/updateAttestAgreementWillsContract'/>" method="post">
            <div class="card-body">
