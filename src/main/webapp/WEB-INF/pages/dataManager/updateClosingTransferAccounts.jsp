...
<html>
<head>
    <title>Update for Closing and Transfer of Shares and Accounts </title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Update for Closing and Transfer of Shares and Accounts </span>

    <div class="col-12">
        <form class="card form-horizontal" id="updateClosingTransferAccountsFormId"
              action="<c:url value='/updateClosingTransferAccounts'/>" method="post">
            <div class="card-body">
