...
<html>
<head>
    <title>Application for Non-National Marriage Certificate Registration Form</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Application for Non-National Marriage Certificate Registration Form </span>

    <div class="col-12">
        <form class="card form-horizontal" id="nonNationalMarriageCertificateFormId"
              action="<c:url value="/nonNationalMarriageCertificate"/>" method="post" enctype="multipart/form-data">
            <div class="card-body">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane" id="personalDetailTab">
                                        ...
                                        <hr>
                                        <label><i class="fa fa-user"></i>&nbsp;<u>Non-National Spouse Details</u></label></br></br>
                                        <div class="form-group">
                                            <label class="col-sm-2 required">
                                                SRP No:
                                                <a data-toggle="tooltip" data-placement="top"
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control field numeric" id="srpNo"
                                                       name="srpNo" maxlength="11"/>
                                                <span id="srpNoNoErrorMsg" class="text-danger"></span>
                                            </div>
                                            <label class="col-sm-2">Full Name:</label>

                                            <div class="col-sm-4">
                                                <input type="text" readonly="true" class="form-control field"
                                                       name="nonNationalSpouseName" id="nonNationalSpouseName">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-2">Gender:</label>
                                            ...
                                            <div class="col-sm-4">
                                                <select id="nonNationalSpouseGender" name="nonNationalSpouseGender"  class="form-control field" readonly="true">
                                                    <option value="">--SELECT--</option>
                                                    <option value="M">Male</option>
                                                    <option value="F">Female</option>
                                                </select>
                                            ...
                                            <label class="col-sm-2 required">
                                                Country:
                                                <a data-toggle="tooltip" data-placement="top"
                                                   title='Please select your spouse country name.'
                                                   class="tooltipCSSSelector">
                                                    <img src="<c:url value="/resources/images/questionMark.jpg"/>" class="user-image"
                                                         width="20px">
                                            ...
                                            <div class="col-sm-4">
                                                <form:select id="countryId" name="countryId" path="country_list"
                                                             class="form-control field">
                                                    <form:option value="" label="--SELECT--"></form:option>
                                                    <form:options items="${country_list}" itemValue="valueInteger"
                                                                  itemLabel="text"></form:options>
                                                </form:select>
                                        ...
                                        <div class="form-group" id="confirmChildDiv" style="display: none;">
                                            <div class="table-responsive">
                                                <table class="table card-table table-vcenter text-nowrap"
                                                    ...
                                                    <tr id="puTr">
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control datepicker field" id="childDob" name='childDob' palceholder="Child Date of Birth" required>
                                                            <span id="childDobErrorMsg" class="text-danger"></span>
                                                        </td>
                                                        <td>
                                                            <select id="childGender" name="childGender"  class="form-control field">
                                                                <option value="">--SELECT--</option>
                                                                <option value="M">Male</option>
                                                                <option value="F">Female</option>
                                                            </select>
                                    ...
                                    <div class="tab-pane" id="otherInformationTab">
                                        <br/><hr/>
                                        <div class="form-group">
                                            <label class="col-sm-2">Appoinement Date: </label>
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control datepicker field" id="appoinmentDate" name="appoinmentDate">
                                                <span id="appoinmentDateErrorMsg" class="text-danger"></span>
                                            </div>
                                            <label class="col-sm-2 required">Remarks :</label>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <ol>
                                                <li>Duly filled Affidavit of Parties/Witnesses In-re Marriage Certificate form (Form No G-6
                                                    ...
                                                    Please fill the forms in Dzongkha, each party should sign on an independent legal stamp and please avoid any overwriting otherwise the application will not be accepted)</li>
