...
<html>
<head>
    <title>Verification for Divorce Marriage Certificate</title>
</head>
<body>
<div class="row" id="registration">
    <span style="font-size: 20px"><b>&nbsp;&nbsp;&nbsp;&nbsp;Judicial Service </b> >>Verification for Divorce Marriage Certificate</span>

    <div class="col-12">
        <form class="card form-horizontal" id="approveDivorceMarriageCertificateFormId"
              action="<c:url value='/approveDivorceMarriageCertificate'/>" method="post">
