        ...
        <div class="row">
            <div class="col-12">
                <form class="card form-horizontal" id="trackApplicationFormId"
                      action="<c:url value='/trackApplication/trackApplicationAP'/>" method="post">
                    <div class="card-body">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="button" class="btn btn-primary" id="btnView" onclick="getTrackApplicationDetailAP()"><i
...
<script>
    function getTrackApplicationDetailAP() {
        ...
        var url = '${pageContext.request.contextPath}/trackApplication/getTrackApplicationDetailAP';
        $.ajax({
            url: url
            , type: 'GET'
            ...
            , success: function (res) {
                ...
                if (res.responseStatus == 1) {
                    ...
                    $('#applicationNo').val();
                    $('#applicationNoErrorMsg').html('Enter valid application no. or CID for Authentication Personal Details').show();
