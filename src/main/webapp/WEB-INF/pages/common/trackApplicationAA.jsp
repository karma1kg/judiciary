        ...
        <div class="row">
            <div class="col-12">
                <form class="card form-horizontal" id="trackApplicationFormId"
                      action="<c:url value='/trackApplication/trackApplicationAA'/>" method="post">
                    <div class="card-body">
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <button type="button" class="btn btn-primary" id="btnView" onclick="getTrackApplicationDetailAA()"><i
...
<script>
    function getTrackApplicationDetailAA() {
        var applicationNo = $('#applicationNo').val();
        if(applicationNo==null||applicationNo==''){
            $('#applicationNoErrorMsg').html('Please Enter Application number or CID').show();
            return false;
        }
        if(applicationNo!=null||applicationNo!=''){
        ...
        var url = '${pageContext.request.contextPath}/trackApplication/getTrackApplicationDetailAA';
        $.ajax({
            url: url
            , type: 'GET'
            ...
            , success: function (res) {
                ...
                if (res.responseStatus == 1) {
                    ...
                    $('#applicationNo').val();
                    $('#applicationNoErrorMsg').html('Enter valid application no. or CID for Attest Agreements,Wills, contracts and Testaments').show();
