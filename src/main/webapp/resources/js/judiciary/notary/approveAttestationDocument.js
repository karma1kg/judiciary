 ...
 */
approveAttestationDocument = (function () {
    var form = $('#approveAttestationDocumentFormId');

    function _baseURL() {
        return 'approveAttestationDocument/';
    }
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveAttestationDocument';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            var url = _baseURL() + 'saveApproveAttestationDocuments';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveAttestationDocument.disableTabs();
        approveAttestationDocument.getApplicationDetail();
        approveAttestationDocument.btnNext();
        approveAttestationDocument.btnPrevious();
        approveAttestationDocument.showHideRejectRemarks();
        approveAttestationDocument.removeErrorMsg();
        approveAttestationDocument.approveOrReject();
        approveAttestationDocument.reject();
        approveAttestationDocument.downloadFile();
        approveAttestationDocument.getAttachedFiles();
        approveAttestationDocument.downloadApplicationNo();
        approveAttestationDocument.downloadApplicationNoReject();
    });