 ...
 */
approveLostDocument = (function () {
    var form = $('#approveLostDocumentFormId');

    function _baseURL() {
        return 'approveLostDocument/';
    }
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveLostDocument';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            var url = _baseURL() + 'saveApproveLostDocuments';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveLostDocument.disableTabs();
        approveLostDocument.getApplicationDetail();
        approveLostDocument.btnNext();
        approveLostDocument.btnPrevious();
        approveLostDocument.showHideRejectRemarks();
        approveLostDocument.removeErrorMsg();
        approveLostDocument.approveOrReject();
        approveLostDocument.reject();
        approveLostDocument.downloadFile();
        approveLostDocument.getAttachedFiles();
        approveLostDocument.downloadApplicationNo();
        approveLostDocument.downloadApplicationNoReject();
    });