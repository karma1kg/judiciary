...
approveAffirmationMarriageCertificate = (function () {
    var form = $('#approveAffirmationMarriageCertificateFormId');

    function _baseURL() {
        return 'approveAffirmationMarriageCertificate/';
    }
    ...
    function approveOrReject() {
        $('.btnSave').on('click', function () {
            ...
            if (btnType == 'btnApprove') {
               ...
               */
/* document.getElementById('appoinmentDate').disabled=false;
                document.getElementById('appoinmentTime').disabled=false;
                if( document.getElementById('appoinmentDate').disable == false){
                    document.getElementById('appoinmentDate').removeAttribute('disabled','disabled');
                }
                if( document.getElementById('appoinmentTime').disable == false){
                    document.getElementById('appoinmentTime').removeAttribute('disabled','disabled');
                }
*//*
...
/* if(remarks == ''){
                    ...
                    $('#remarksErrorMsg').text('Remarks is required');
                    return;
                }*//*

            }

            var url = _baseURL() + 'saveApproveAffirmationMarriageCertificate';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            if (btnType == 'btnApprove') {
                ...
                if(appoinmentTime == ''){
                    $('#appoinmentTime').removeClass('error');
                    $('#appoinmentTimeErrorMsg').text('Appointment time is required');
                    return;
                }
            ...
            var url = _baseURL() + 'saveApproveAffirmationMarriageCertificates';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveAffirmationMarriageCertificate.disableTabs();
        approveAffirmationMarriageCertificate.getApplicationDetail();
        approveAffirmationMarriageCertificate.btnNext();
        approveAffirmationMarriageCertificate.btnPrevious();
        approveAffirmationMarriageCertificate.showHideRejectRemarks();
        approveAffirmationMarriageCertificate.removeErrorMsg();
        approveAffirmationMarriageCertificate.approveOrReject();
        approveAffirmationMarriageCertificate.reject();
        approveAffirmationMarriageCertificate.downloadFile();
        approveAffirmationMarriageCertificate.getAttachedFiles();
        approveAffirmationMarriageCertificate.downloadApplicationNo();
        approveAffirmationMarriageCertificate.downloadApplicationNoReject();
    });*/
/**
 * Created by Sonam Tobgay on 4/1/2020.
 */
        ...
        $('.btnSaves').on('click', function () {
            ...
            *//*if (rejectReasonId == 4 && rejectRemarks == '') {
                ...
                return;
                        ...
                        var url = _baseURL() + 'saveApproveAffirmationMarriageCertificates?applicationNo='+applicationNo+'&remarks='+remarks+'&rejectedId='+rejectReasonId+'&mobileNo='+mobileNo;
            $.ajax({
                            url: url,
                            type: 'POST',
                            success: function (res) {
