 ...
 */
approveAttestAgreementWillsContract = (function () {
    var form = $('#approveAttestAgreementWillsContractFormId');

    function _baseURL() {
        return 'approveAttestAgreementWillsContract/';
    }
    ...
    function getApplicationDetail() {
        ...
        $.ajax({
            ...
            , success: function (res) {
                ...
                var data1 = res.witness1DTO;
                var data2 = res.witness2DTO;
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveAttestAgreementWillsContract';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            var url = _baseURL() + 'saveApproveAttestAgreementWillsContracts';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveAttestAgreementWillsContract.disableTabs();
        approveAttestAgreementWillsContract.getApplicationDetail();
        approveAttestAgreementWillsContract.btnNext();
        approveAttestAgreementWillsContract.btnPrevious();
        approveAttestAgreementWillsContract.showHideRejectRemarks();
        approveAttestAgreementWillsContract.removeErrorMsg();
        approveAttestAgreementWillsContract.approveOrReject();
        approveAttestAgreementWillsContract.reject();
        approveAttestAgreementWillsContract.downloadFile();
        approveAttestAgreementWillsContract.getAttachedFiles();
        approveAttestAgreementWillsContract.downloadApplicationNo();
        approveAttestAgreementWillsContract.downloadApplicationNoReject();
    });