 ...
 */
approveChildTravelDocument = (function () {
    var form = $('#approveChildTravelDocumentFormId');

    function _baseURL() {
        return 'approveChildTravelDocument/';
    }
    ...
    function getApplicationDetail() {
        ...
        $.ajax({
            ...
            , success: function (res) {
                ...
                var data1 = res.motherDTO;
                var data2 = res.fatherDTO;
                var data5 = res.applicantDTO;
                var data7 = res.childTravelDetailDTO;
                if (res.responseStatus == 1) {
                    ...
                    populate(data5);
                    populate(data7);
                    $('#childDob').val(formatAsDate(data7.childDob));
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveChildTravelDocument';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            var url = _baseURL() + 'saveApproveChildTravelDocuments';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveChildTravelDocument.disableTabs();
        approveChildTravelDocument.getApplicationDetail();
        approveChildTravelDocument.btnNext();
        approveChildTravelDocument.btnPrevious();
        approveChildTravelDocument.showHideRejectRemarks();
        approveChildTravelDocument.removeErrorMsg();
        approveChildTravelDocument.approveOrReject();
        approveChildTravelDocument.reject();
        approveChildTravelDocument.downloadFile();
        approveChildTravelDocument.getAttachedFiles();
        approveChildTravelDocument.downloadApplicationNo();
        approveChildTravelDocument.downloadApplicationNoReject();
    });