 ...
 */
approveMarriageCertificate = (function () {
    var form = $('#approveMarriageCertificateFormId');

    function _baseURL() {
        return 'approveMarriageCertificate/';
    }
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveMarriageCertificate';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject() {
        $('.btnSaves').on('click', function () {
            ...
            rejectReasonId=vals;
            var url = _baseURL() + 'saveApproveMarriageCertificates?applicationNo='+applicationNo+'&remarks='+remarks+'&rejectedId='+rejectReasonId+'&mobileNo='+mobileNo;
            $.ajax({
                url: url,
                type: 'POST',
                success: function (res) {
...
$(document).ready(
    function () {
        approveMarriageCertificate.disableTabs();
        approveMarriageCertificate.getApplicationDetail();
        approveMarriageCertificate.downloadFile();
        approveMarriageCertificate.getAttachedFiles();
        approveMarriageCertificate.btnNext();
        approveMarriageCertificate.btnPrevious();
        approveMarriageCertificate.showHideRejectRemarks();
        approveMarriageCertificate.removeErrorMsg();
        approveMarriageCertificate.approveOrReject();
        approveMarriageCertificate.reject();
        approveMarriageCertificate.downloadApplicationNo();
        approveMarriageCertificate.downloadApplicationNoReject();
    });
