 ...
 */
approveOrganTransplant = (function () {
    var form = $('#approveOrganTransplantFormId');

    function _baseURL() {
        return 'approveOrganTransplant/';
    }
    ...
    function getApplicationDetail() {
        ...
        $.ajax({
            ...
            , success: function (res) {
                ...
                var data1 = res.patientDTO;
                var data2 = res.donorDTO;
                var data3 = res.donorDepDTO;
                var data4 = res.witness1DTO;
                var data5 = res.witness2DTO;
                var data6 = res.applicantDTO;
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveOrganTransplant';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            var url = _baseURL() + 'saveApproveOrganTransplants';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveOrganTransplant.disableTabs();
        approveOrganTransplant.getApplicationDetail();
        approveOrganTransplant.btnNext();
        approveOrganTransplant.btnPrevious();
        approveOrganTransplant.showHideRejectRemarks();
        approveOrganTransplant.removeErrorMsg();
        approveOrganTransplant.approveOrReject();
        approveOrganTransplant.reject();
        approveOrganTransplant.downloadFile();
        approveOrganTransplant.getAttachedFiles();
        approveOrganTransplant.downloadApplicationNo();
        approveOrganTransplant.downloadApplicationNoReject();
    });