 ...
 */
approveSingleMaritalStatus = (function () {
    var form = $('#approveSingleMaritalStatusFormId');

    function _baseURL() {
        return 'approveSingleMaritalStatus/';
    }
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveSingleMaritalStatus';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            var url = _baseURL() + 'saveApproveSingleMaritalStatuss';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveSingleMaritalStatus.disableTabs();
        approveSingleMaritalStatus.getApplicationDetail();
        approveSingleMaritalStatus.btnNext();
        approveSingleMaritalStatus.btnPrevious();
        approveSingleMaritalStatus.showHideRejectRemarks();
        approveSingleMaritalStatus.removeErrorMsg();
        approveSingleMaritalStatus.approveOrReject();
        approveSingleMaritalStatus.reject();
        approveSingleMaritalStatus.downloadFile();
        approveSingleMaritalStatus.getAttachedFiles();
        approveSingleMaritalStatus.downloadApplicationNo();
        approveSingleMaritalStatus.downloadApplicationNoReject();
    });