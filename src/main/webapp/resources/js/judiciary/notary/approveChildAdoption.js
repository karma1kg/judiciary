 ...
 */
approveChildAdoption = (function () {
    var form = $('#approveChildAdoptionFormId');

    function _baseURL() {
        return 'approveChildAdoption/';
    }
    ...
    function getApplicationDetail() {
        ...
        $.ajax({
            ...
            , success: function (res) {
                ...
                var data4 = res.motherDTO;
                var data5 = res.fatherDTO;
        ...
        $('.btnSave').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    var data = res.responseDTO;
                    if (res.responseStatus == 1) {
                        var url = _baseURL() + 'saveApproveChildAdoption';
                        $.ajax({
                            url: url,
                            type: 'POST',
                            data: {
    ...
    function reject(){
        $('.btnSaves').on('click', function () {
            ...
            var url = _baseURL() + 'saveApproveChildAdoptions';
            $.ajax({
                url: url,
                type: 'POST',
                data: {
...
$(document).ready(
    function () {
        approveChildAdoption.disableTabs();
        approveChildAdoption.getApplicationDetail();
        approveChildAdoption.btnNext();
        approveChildAdoption.btnPrevious();
        approveChildAdoption.showHideRejectRemarks();
        approveChildAdoption.removeErrorMsg();
        approveChildAdoption.approveOrReject();
        approveChildAdoption.reject();
        approveChildAdoption.downloadFile();
        approveChildAdoption.getAttachedFiles();
        approveChildAdoption.downloadApplicationNo();
        approveChildAdoption.downloadApplicationNoReject();
    });