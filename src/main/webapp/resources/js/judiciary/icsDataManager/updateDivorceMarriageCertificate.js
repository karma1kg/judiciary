...
updateDivorceMarriageCertificate = (function () {
    var form = $('#updateDivorceMarriageCertificateFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateDivorceMarriageCertificate/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateDivorceMarriageCertificateFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'saveUpdateDivorceMarriageCertificate';
...
$(document).ready(
    function () {
        updateDivorceMarriageCertificate.disableTabs();
        updateDivorceMarriageCertificate.checkPreviousJudgementNo();
        updateDivorceMarriageCertificate.checkPreviousRegistrationNo();
        updateDivorceMarriageCertificate.getApplicationDetail();
        updateDivorceMarriageCertificate.btnNext();
        updateDivorceMarriageCertificate.btnPrevious();
        updateDivorceMarriageCertificate.removeErrorMsg();
        updateDivorceMarriageCertificate.updateApplication();
    });