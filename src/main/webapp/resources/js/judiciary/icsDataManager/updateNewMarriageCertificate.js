 ...
 */
updateNewMarriageCertificate = (function () {
    var form = $('#updateNewMarriageCertificateFormId');
    var isSubmitted = false;
    function _baseURL() {
        return 'updateNewMarriageCertificate/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(checkUpdateDetail()){
                $('#updateNewMarriageCertificateFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateNewMarriageCertificate';
                        alert(url);
...
$(document).ready(
    function () {
        updateNewMarriageCertificate.disableTabs();
        updateNewMarriageCertificate.checkPreviousJudgementNo();
        updateNewMarriageCertificate.checkPreviousRegistrationNo();
        updateNewMarriageCertificate.getApplicationDetail();
        updateNewMarriageCertificate.btnNext();
        updateNewMarriageCertificate.btnPrevious();
        updateNewMarriageCertificate.removeErrorMsg();
        updateNewMarriageCertificate.updateApplication();
    });
