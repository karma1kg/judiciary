 ...
 */
affirmationMarriageCertificate = (function () {
    "use strict";
    var form = $('#affirmationMarriageCertificateFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'affirmationMarriageCertificate/';
    }
    ...
    function saveAffirmationMarriageCertificate() {
        $('#btnSubmit').on('click', function () {
            $('#affirmationMarriageCertificateFormId').validate({
                submitHandler: function (form) {
                    var url = _baseURL() + 'saveAffirmationMarriageCertificate';
    ...
    return {
        ...
        , saveAffirmationMarriageCertificate: saveAffirmationMarriageCertificate
...
$(document).ready(
    function () {
        $('.field').val('');
        affirmationMarriageCertificate.disableTabs();
        affirmationMarriageCertificate.btnNext();
        affirmationMarriageCertificate.btnPrevious();
        affirmationMarriageCertificate.removeErrorMsg();
        affirmationMarriageCertificate.checkForAlreadyExistApplicant();
        affirmationMarriageCertificate.checkForAlreadyExistSpouse();
        affirmationMarriageCertificate.addMoreAttachment();
        affirmationMarriageCertificate.checkFileSize();
        affirmationMarriageCertificate.deleteAttachment();
        affirmationMarriageCertificate.saveAffirmationMarriageCertificate();
        affirmationMarriageCertificate.downloadApplicationNo();
