 ...
 */
marriageCertificate = (function () {
    "use strict";
    var form = $('#marriageCertificateFormId');
                                        ...
                                        success: function (res) {
                                            ...
                                            if (res.responseStatus == 1) {
                                               ...
                                               /*$('#applicantDobBh').val(data.applicantDobBh);*/
                                                ...
                                                $('#gender').val(data.gender);
                                                $('#relationToHOH').val(data.houseNo);
                                                $('#marital_Status').val(data.houseNo);
                                                $('#applicantDob').val(data.applicantDob);
                                                $('#nationality').val(data.nationality);
                                                $('#fatherCid').val(data.fatherName);
                                                $('#fatherName').val(data.fatherName);
                                                $('#fatherNationality').val(data.nationality);
                                                $('#motherName').val(data.motherName);
                                                $('#motherNationality').val(data.nationality);
                      ...
                      /*  var url = _baseURL() + 'checkForAlreadyExistApplicant';
                        $.ajax({
                            ...
                            success: function (res) {
                                ...
                                debugger;
                                if (res.responseStatus == 1) {
                                    var url = _baseURL() + 'getHouseholdDetails';
                                    $.ajax({
                                        url: url,
                                        type: 'GET',
                                        data: {cidNo: cidNo},
                                        success: function (res) {
                                            var data = res.responseDTO;
                                            $('#housholdApplicantDetailsID').show();
                                            if (res.responseStatus == 1) {
                                                var docBtl = '';
                                                var m = 0;
                                                $('#cidNoErrorMsg').html('');
                                                $('#houseNo').val(data.householdNo);
                                                $('#dzongkhagName').val(data.dzongkhagName);
                                                $('#gewogName').val(data.gewogName);
                                                ...
                                                *//*for(var i in data){
                                                    ...
                                                    "<td>" + data[i].motherName + "</td>" +
                                                    "<td>" + data[i].nationality + "</td>" + "</tr>";
                                                }*//*
                                                //$('#applicationDetailTableId').show();
                                                $('#housholdApplicantDetailsThID').find('tbody').html(docBtl);
                                                $('#cidNoErrorMsg').html('');
                                                $('#applicantName').val(data.applicantName);
                                                $('#cidNo').val(data.cidNo);
                                                $('#gender').val(data.gender);
    ...
    function saveMarriageCertificate() {
        $('#btnSubmit').on('click', function () {
            $('#marriageCertificateFormId').validate({
    ...
    return {
        ...
        ,saveMarriageCertificate: saveMarriageCertificate
...
$(document).ready(
    function () {
        $('.field').val('');
        marriageCertificate.disableTabs();
        marriageCertificate.btnNext();
        marriageCertificate.btnPrevious();
        marriageCertificate.onChangeChildDetail();
        marriageCertificate.removeErrorMsg();
        marriageCertificate.addMoreChildDetails();
        marriageCertificate.deleteChildDetails();
        marriageCertificate.checkForAlreadyExistApplicant();
        marriageCertificate.checkForAlreadyExistSpouse();
        marriageCertificate.checkForAlreadyMarriedApplicant();
        marriageCertificate.checkForAlreadyMarriedSpouse();
        marriageCertificate.fetchWitnessMaleCitizenDetails();
        marriageCertificate.fetchWitnessFemaleCitizenDetails();
        marriageCertificate.addMoreAttachment();
        marriageCertificate.checkFileSize();
        marriageCertificate.deleteAttachment();
        marriageCertificate.saveMarriageCertificate();
        marriageCertificate.downloadApplicationNo();
});
