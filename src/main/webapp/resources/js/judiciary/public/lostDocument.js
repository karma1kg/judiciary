 ...
 */
lostDocument = (function () {
    "use strict";
    var form = $('#lostDocumentFormId');
    ...
    function validatePersonalDetail() {
        ...
        if($('#lostDocType').val()==""){
            $('#lostDocType').addClass('error');
            $('#lostDocTypeErrorMsg').html('Document type is required');
            retval = false;
        }
        return retval;
    }
    ...
    function saveLostDocument() {
        $('#btnSubmit').on('click', function () {
            $('#lostDocumentFormId').validate({
                submitHandler: function (form) {
                    var url = _baseURL() + 'saveLostDocument';
    ...
    return {
        ...
        , saveLostDocument: saveLostDocument
...
$(document).ready(
    function () {
        $('.field').val('');
        lostDocument.disableTabs();
        lostDocument.btnNext();
        lostDocument.btnPrevious();
        lostDocument.removeErrorMsg();
        lostDocument.checkForAlreadyExistApplicant();
        lostDocument.addMoreAttachment();
        lostDocument.deleteAttachment();
        lostDocument.checkFileSize();
        lostDocument.saveLostDocument();
        lostDocument.downloadApplicationNo();
    });
