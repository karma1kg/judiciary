 ...
 */
singleMaritalStatus = (function () {
    "use strict";
    var form = $('#singleMaritalStatusFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'singleMaritalStatus/';
    }
    ...
    function saveSingleMaritalStatus() {
        $('#btnSubmit').on('click', function () {
            $('#singleMaritalStatusFormId').validate({
                submitHandler: function (form) {
                    var url = _baseURL() + 'saveSingleMaritalStatus';
    ...
    return {
        ...
        , saveSingleMaritalStatus: saveSingleMaritalStatus
...
$(document).ready(
    function () {
        $('.field').val('');
        singleMaritalStatus.disableTabs();
        singleMaritalStatus.btnNext();
        singleMaritalStatus.btnPrevious();
        singleMaritalStatus.removeErrorMsg();
        singleMaritalStatus.checkForAlreadyExistApplicant();
        singleMaritalStatus.addMoreAttachment();
        singleMaritalStatus.deleteAttachment();
        singleMaritalStatus.checkFileSize();
        singleMaritalStatus.saveSingleMaritalStatus();
        singleMaritalStatus.downloadApplicationNo();
});
