 ...
 */
updateOrganTransplant = (function () {
    var form = $('#updateOrganTransplantFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateOrganTransplant/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateOrganTransplantFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateOrganTransplant';
...
$(document).ready(
    function () {
        updateOrganTransplant.disableTabs();
        updateOrganTransplant.checkPreviousJudgementNo();
        updateOrganTransplant.checkPreviousRegistrationNo();
        updateOrganTransplant.getApplicationDetail();
        updateOrganTransplant.btnNext();
        updateOrganTransplant.btnPrevious();
        updateOrganTransplant.removeErrorMsg();
        updateOrganTransplant.updateApplication();
    });