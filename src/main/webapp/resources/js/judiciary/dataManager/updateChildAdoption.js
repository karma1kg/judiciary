 ...
 */
updateChildAdoption = (function () {
    var form = $('#updateChildAdoptionFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateChildAdoption/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateChildAdoptionFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateChildAdoption';
...
$(document).ready(
    function () {
        updateChildAdoption.disableTabs();
        updateChildAdoption.checkPreviousRegistrationNo();
        updateChildAdoption.checkPreviousJudgementNo();
        updateChildAdoption.getApplicationDetail();
        updateChildAdoption.btnNext();
        updateChildAdoption.btnPrevious();
        updateChildAdoption.removeErrorMsg();
        updateChildAdoption.updateApplication();
    });