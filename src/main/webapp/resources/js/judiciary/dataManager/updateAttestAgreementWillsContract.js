 ...
 */
updateAttestAgreementWillsContract = (function () {
    var form = $('#updateAttestAgreementWillsContractFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateAttestAgreementWillsContract/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateAttestAgreementWillsContractFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateAttestAgreementWillsContract';
...
$(document).ready(
    function () {
        updateAttestAgreementWillsContract.disableTabs();
        updateAttestAgreementWillsContract.checkPreviousRegistrationNo();
        updateAttestAgreementWillsContract.checkPreviousJudgementNo();
        updateAttestAgreementWillsContract.getApplicationDetail();
        updateAttestAgreementWillsContract.btnNext();
        updateAttestAgreementWillsContract.btnPrevious();
        updateAttestAgreementWillsContract.removeErrorMsg();
        updateAttestAgreementWillsContract.updateApplication();
    });