 ...
 */
updateAffirmationMarriageCertificate = (function () {
    var form = $('#updateAffirmationMarriageCertificateFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateAffirmationMarriageCertificate/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateAffirmationMarriageCertificateFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateAffirmationMarriageCertificate';
...
$(document).ready(
    function () {
        updateAffirmationMarriageCertificate.disableTabs();
        updateAffirmationMarriageCertificate.checkPreviousJudgementNo();
        updateAffirmationMarriageCertificate.checkPreviousRegistrationNo();
        updateAffirmationMarriageCertificate.getApplicationDetail();
        updateAffirmationMarriageCertificate.btnNext();
        updateAffirmationMarriageCertificate.btnPrevious();
        updateAffirmationMarriageCertificate.removeErrorMsg();
        updateAffirmationMarriageCertificate.updateApplication();
    });