 ...
 */
updateAuthenticationPersonalDetails = (function () {
    var form = $('#updateAuthenticationPersonalDetailsFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateAuthenticationPersonalDetails/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateAuthenticationPersonalDetailsFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateAuthenticationPersonalDetails';
...
$(document).ready(
    function () {
        updateAuthenticationPersonalDetails.disableTabs();
        updateAuthenticationPersonalDetails.checkPreviousRegistrationNo();
        updateAuthenticationPersonalDetails.checkPreviousJudgementNo();
        updateAuthenticationPersonalDetails.getApplicationDetail();
        updateAuthenticationPersonalDetails.btnNext();
        updateAuthenticationPersonalDetails.btnPrevious();
        updateAuthenticationPersonalDetails.removeErrorMsg();
        updateAuthenticationPersonalDetails.updateApplication();
    });