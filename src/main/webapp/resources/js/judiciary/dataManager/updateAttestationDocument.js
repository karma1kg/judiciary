 ...
 */
updateAttestationDocument = (function () {
    var form = $('#updateAttestationDocumentFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateAttestationDocument/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateAttestationDocumentFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateAttestationDocument';
...
$(document).ready(
    function () {
        updateAttestationDocument.disableTabs();
        updateAttestationDocument.checkPreviousJudgementNo();
        updateAttestationDocument.checkPreviousRegistrationNo();
        updateAttestationDocument.getApplicationDetail();
        updateAttestationDocument.btnNext();
        updateAttestationDocument.btnPrevious();
        updateAttestationDocument.removeErrorMsg();
        updateAttestationDocument.updateApplication();
    });