 ...
 */
updateSingleMaritalStatus = (function () {
    var form = $('#updateSingleMaritalStatusFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateSingleMaritalStatus/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateSingleMaritalStatusFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateSingleMaritalStatus';
...
$(document).ready(
    function () {
        updateSingleMaritalStatus.disableTabs();
        updateSingleMaritalStatus.checkPreviousRegistrationNo();
        updateSingleMaritalStatus.checkPreviousJudgementNo();
        updateSingleMaritalStatus.getApplicationDetail();
        updateSingleMaritalStatus.btnNext();
        updateSingleMaritalStatus.btnPrevious();
        updateSingleMaritalStatus.removeErrorMsg();
        updateSingleMaritalStatus.updateApplication();
    });