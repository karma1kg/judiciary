 ...
 */
updateChildTravelDocument = (function () {
    var form = $('#updateChildTravelDocumentFormId');
    var isSubmitted = false;

    function _baseURL() {
        return 'updateChildTravelDocument/';
    }
    ...
    function updateApplication() {
        $('#btnUpdate').on('click', function () {
            if(validateUpdate()){
                $('#updateChildTravelDocumentFormId').validate({
                    submitHandler: function (form) {
                        var url = _baseURL() + 'updateChildTravelDocument';
...
$(document).ready(
    function () {
        updateChildTravelDocument.disableTabs();
        updateChildTravelDocument.checkPreviousRegistrationNo();
        updateChildTravelDocument.checkPreviousJudgementNo();
        updateChildTravelDocument.getApplicationDetail();
        updateChildTravelDocument.btnNext();
        updateChildTravelDocument.btnPrevious();
        updateChildTravelDocument.removeErrorMsg();
        updateChildTravelDocument.updateApplication();
    });