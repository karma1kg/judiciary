...
*/
    updateLostDocument = (function () {
        var form = $('#updateLostDocumentFormId');
        var isSubmitted = false;

        function _baseURL() {
            return 'updateLostDocument/';
        }
        ...
        function updateApplication() {
            $('#btnUpdate').on('click', function () {
                if(validateUpdate()){
                    $('#updateLostDocumentFormId').validate({
                        submitHandler: function (form) {
                            var url = _baseURL() + 'updateLostDocument';
    ...
    $(document).ready(
        function () {
            updateLostDocument.disableTabs();
            updateLostDocument.checkPreviousRegistrationNo();
            updateLostDocument.getApplicationDetail();
            updateLostDocument.checkPreviousJudgementNo();
            updateLostDocument.btnNext();
            updateLostDocument.btnPrevious();
            updateLostDocument.removeErrorMsg();
            updateLostDocument.updateApplication();
        });