...
import com.spring.mvc.judiciary.service.notaryService.ApproveOrganTransplantService;
 ...
 */
@Controller
@RequestMapping("/approveOrganTransplant")
public class ApproveOrganTransplantController {
    @Autowired
    private ApproveOrganTransplantService approveOrganTransplantService;
    @Autowired
    ...
    public String index(ModelMap model) {
        if (model.size() != 0) {
            ...
            return "notary/approveOrganTransplant";
        } else {
    ...
    @ResponseBody
    @RequestMapping(value = "/saveApproveOrganTransplant", method = RequestMethod.POST)
    public ResponseMessage saveApproveOrganTransplant(HttpServletRequest request,
        ...
        responseMessage = approveOrganTransplantService.approveApplication(userBean,
                applicationNo, remarks, rejectReasonId,appoinmentDate,appoinmentTime,mobileNo);
        return responseMessage;
    }

    @ResponseBody
    @RequestMapping(value = "/saveApproveOrganTransplants", method = RequestMethod.POST)
    public ResponseMessage saveApproveOrganTransplants( HttpServletRequest request, HttpServletResponse response,String applicationNo,String remarks, Integer rejectReasons,String mobileNo)
            throws Exception {
       /* String rejectReasonId=request.getParameter("rejectedId");
        ...
        UserRolePrivilegeDto userBean = (UserRolePrivilegeDto) request.getSession().getAttribute("UserRolePrivilege");
        responseMessage = approveOrganTransplantService.approveApplications(userBean,
