...
import com.spring.mvc.judiciary.service.dataManager.UpdateOrganTransplantService;
 ...
 */
@Controller
@RequestMapping("/updateOrganTransplant")
public class UpdateOrganTransplantController {
    @Autowired
    private UpdateOrganTransplantService updateOrganTransplantService;
    @Autowired
    ...
    public String index(ModelMap model) {
        if (model.size() != 0) {
            ...
            return "dataManager/updateOrganTransplant";
        } else {
    ...
    @ResponseBody
    @RequestMapping(value = "/updateOrganTransplant", method = RequestMethod.POST)
    public ResponseMessage updateOrganTransplant(HttpServletRequest request, ApplicationDetailDTO applicationDetailDTO) throws Exception {
        ...
        UserRolePrivilegeDto userBean = (UserRolePrivilegeDto) request.getSession().getAttribute("UserRolePrivilege");
        responseMessage = updateOrganTransplantService.updateApplication(userBean,
