...
import com.spring.mvc.judiciary.service.dataManager.UpdateChildTravelDocumentService;
 ...
 */
@Controller
   @RequestMapping("/updateChildTravelDocument")
public class UpdateChildTravelDocumentController {
    @Autowired
    private UpdateChildTravelDocumentService updateChildTravelDocumentService;
    @Autowired
    ...
    public String index(ModelMap model) {
        if (model.size() != 0) {
            ...
            return "dataManager/updateChildTravelDocument";
        } else {
    ...
    @ResponseBody
    @RequestMapping(value = "/updateChildTravelDocument", method = RequestMethod.POST)
    public ResponseMessage updateChildTravelDocument(HttpServletRequest request, ApplicationDetailDTO applicationDetailDTO,String applicationYear) throws Exception {
        ...
        UserRolePrivilegeDto userBean = (UserRolePrivilegeDto) request.getSession().getAttribute("UserRolePrivilege");
        responseMessage = updateChildTravelDocumentService.updateApplication(userBean,
