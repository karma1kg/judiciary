...
import com.spring.mvc.judiciary.service.icsNotaryService.ApproveDivorceMarriageCertificateService;
 ...
 */
@Controller
@RequestMapping("/approveDivorceMarriageCertificate")
public class ApproveDivorceMarriageCertificate {
    /**
     * declare of required private variables
     */
    @Autowired
    private ApproveDivorceMarriageCertificateService approveDivorceMarriageCertificateService;
    @Autowired
    ...
    public String index(final ModelMap model) {
        if (model.size() != 0) {
            ...
            return "icsNotary/approveDivorceMarriageCertificate";
        }
...
*/
    ...
    public ResponseMessage saveApproveAffirmationMarriageCertificate(HttpServletRequest request, HttpServletResponse response, String applicationNo, String remarks, Date appoinmentDate, String appoinmentTime, String mobileNo) throws Exception {
        ...
        this.responseMessage = this.approveDivorceMarriageCertificateService.approveApplication(userBean, applicationNo, remarks, rejectReasonId, appoinmentDate, appoinmentTime, mobileNo);
    ...
    public ResponseMessage saveApproveAffirmationMarriageCertificates(HttpServletRequest request, HttpServletResponse response,String applicationNo,String remarks, Integer rejectReasons,String mobileNo) throws Exception {
       ...
       // String array[]=request.getParameterValues("");
        ...
        this.responseMessage = this.approveDivorceMarriageCertificateService.approveApplications(userBean, applicationNo, remarks, rejectReasons, rejectRemarks, mobileNo);
        return this.responseMessage;
    }
}
