...
import com.spring.mvc.judiciary.service.icsDataManager.UpdateDivorceMarriageCertificateService;
 ...
 */
@Controller
@RequestMapping("/updateDivorceMarriageCertificate")
public class UpdateDivorceMarriageCertificateController {
    @Autowired
    private UpdateDivorceMarriageCertificateService updateDivorceMarriageCertificateService;
    @Autowired
    ...
    public UpdateDivorceMarriageCertificateController() {
    ...
    public String index(final ModelMap model) {
        if (model.size() != 0) {
            ...
            return "icsDataManager/updateDivorceMarriageCertificate";
        }
     ...
     */
    @ResponseBody
    @RequestMapping(value = { "/saveUpdateDivorceMarriageCertificate" }, method = { RequestMethod.POST })
    public ResponseMessage updateAffirmationMarriageCertificate(final HttpServletRequest request, final ApplicationDetailDTO applicationDetailDTO) throws Exception {
        ...
        final UserRolePrivilegeDto userBean = (UserRolePrivilegeDto)request.getSession().getAttribute("UserRolePrivilege");
        return this.responseMessage = this.updateDivorceMarriageCertificateService.updateApplication(userBean, applicationNo, regNo, regDate, judgementNo, judgementDate, lawyer);
    }
}
