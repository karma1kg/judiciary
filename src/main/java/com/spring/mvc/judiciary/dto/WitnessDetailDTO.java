...
public class WitnessDetailDTO {
   ...
   /* private String witnessCidNo;
    ...
    public String getWitnessFathersName() {
        return witnessFathersName;
    }

    public void setWitnessFathersName(String witnessFathersName) {
        this.witnessFathersName = witnessFathersName;
    }
    ...
    public String getWitnessHouseNo() {
        return witnessHouseNo;
    }

    public void setWitnessHouseNo(String witnessHouseNo) {
        this.witnessHouseNo = witnessHouseNo;
    }

    public String getWitnessTharmNo() {
        return witnessTharmNo;
    }

    public void setWitnessTharmNo(String witnessTharmNo) {
        this.witnessTharmNo = witnessTharmNo;
    }*/
