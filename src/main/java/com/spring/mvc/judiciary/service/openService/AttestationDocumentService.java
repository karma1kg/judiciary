 ...
 */
@Service
public class AttestationDocumentService {
    ...
    public ResponseMessage saveAttestationDocument(HttpServletRequest request,
        ...
        String applicationType = ServiceTypeEnum.ATTESTATION_OF_DOCUMENT.getServiceCode();
