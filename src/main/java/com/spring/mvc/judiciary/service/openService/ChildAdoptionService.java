 ...
 */
@Service
public class ChildAdoptionService {
    ...
    public ResponseMessage saveChildAdoption(HttpServletRequest request,
        ...
        String applicationType = ServiceTypeEnum.CHILD_ADOPTION.getServiceCode();
        ...
        responseMessage.setServiceName(ServiceTypeEnum.CHILD_ADOPTION.getServiceName());
