 ...
 */
@Service
public class ClosingTransferAccountsService {
    ...
    public ResponseMessage saveClosingTransferAccounts(HttpServletRequest request,
        ...
        String applicationType = ServiceTypeEnum.CLOSING_AND_TRANSFER_OF_SHARES_AND_ACCOUNTS.getServiceCode();
        ...
        String serviceName = ServiceTypeEnum.CLOSING_AND_TRANSFER_OF_SHARES_AND_ACCOUNTS.getServiceName();
