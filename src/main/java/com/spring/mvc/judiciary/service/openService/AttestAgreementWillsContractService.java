 ...
 */
@Service
public class AttestAgreementWillsContractService {
    ...
    public ResponseMessage saveAttestAgreementWillsContract(HttpServletRequest request,
        ...
        String applicationType = ServiceTypeEnum.ATTEST_AGREEMENTS_WILLS_CONTRACTS_AND_TESTAMENTS.getServiceCode();
