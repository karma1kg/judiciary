 ...
 */
@Service
public class ApproveLostDocumentService {
    @Autowired
    ...
    public ResponseMessage approveApplication(UserRolePrivilegeDto userBean, String applicationNo, String remarks,
                                              String rejectReasonId, String rejectRemarks, Date appoinmentDate,String appoinmentTime,String mobileNo) throws ParseException {
        ...
        responseMessage.setServiceName(ServiceTypeEnum.LOST_DOCUMENTS.getServiceName());
