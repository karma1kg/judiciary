 ...
 */
@Service
public class ApproveAttestationDocumentService {
    @Autowired
    ...
    public ResponseMessage approveApplication(UserRolePrivilegeDto userBean, String applicationNo, String remarks,
                                              String rejectReasonId, Date appoinmentDate,String appoinmentTime,String mobileNo,String applicationYear) throws ParseException {
        ...
        responseMessage.setServiceName(ServiceTypeEnum.ATTESTATION_OF_DOCUMENT.getServiceName());
    ...
    public ResponseMessage approveApplications(UserRolePrivilegeDto userBean, String applicationNo, String remarks,
                                               Integer rejectReasonId,String rejectRemarks, String mobileNo) throws ParseException {
        ResponseMessage responseMessage = new ResponseMessage();
        try {
            ...
            if (rejectReasonId != 0) {
                ...
                var19 = CommonNotificationUtils.notifyOnRejections(responseMessage, contactNums, str);
            } else {
