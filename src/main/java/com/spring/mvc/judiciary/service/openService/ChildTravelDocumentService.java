 ...
 */
@Service
public class ChildTravelDocumentService {
    ...
    public ResponseMessage saveChildTravelDocument(HttpServletRequest request,
        ...
        String applicationType = ServiceTypeEnum.CHILD_TRAVEL_DOCUMENT.getServiceCode();
