 ...
 */
@Service
public class SingleMaritalStatusService {
    ...
    public ResponseMessage saveSingleMaritalStatus(HttpServletRequest request,
        ...
        String applicationType = ServiceTypeEnum.SINGLE_MARITAL_STATUS.getServiceCode();
        ...
        responseMessage.setServiceName(ServiceTypeEnum.SINGLE_MARITAL_STATUS.getServiceName());
